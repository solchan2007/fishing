...
def purchase_item(saveinfo: dict):
	result = {"success": False, "errormessage": ""}
	if('username' in saveinfo and 'market_item' in saveinfo and 'isfood' in saveinfo):
		data_dict = json_file_to_dict()
		# 음식 정보 불러오기
		...
		result.update({"success": False, "errormessage": "username 또는 market_item 또는 isfood 값이 누락되었습니다."})
	return result
...
def sell_fish(saveinfo: dict):
	result = {"success": False, "errormessage": ""}
	if('username' in saveinfo and 'fish_name' in saveinfo and 'quantity' in saveinfo):
		data_dict = json_file_to_dict()
		# 물고기 정보 불러오기
		file1 = open("fishdata.json", "r", encoding='UTF-8')
		jsondata1 = json.load(file1)
		...
		result.update({"success": False, "errormessage": "username 또는 fish_name 또는 quantity 값이 누락되었습니다."})
	return result
'''
...
def eat_food(saveinfo: dict):
	result = {"success": False, "errormessage": ""}
	if('username' in saveinfo and 'food_name' in saveinfo):
		data_dict = json_file_to_dict()
		# 음식 정보 불러오기
		file1 = open("fooddata.json", "r", encoding='UTF-8')
		jsondata1 = json.load(file1)
		...
		result.update({"success": False, "errormessage": "username 또는 food_name 값이 누락되었습니다."})
	return result
...
def change_fishing_rod(saveinfo: dict):
	result = {"success": False, "errormessage": ""}
	if('username' in saveinfo and 'fishing_rod' in saveinfo):
		data_dict = json_file_to_dict()
		username = saveinfo['username']
		...
		result.update({"success": False, "errormessage": "username 또는 fishing_rod 값이 누락되었습니다."})
	return result
